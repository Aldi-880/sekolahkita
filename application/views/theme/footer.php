<footer class="footer">
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                ...
                                <p>sdnbanyuajuh2kamal@gmail.com</p>
                            </div>
                        </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> <a href="https://suryaciptainformatika.com/" target="_blank">SDN Banuyuajuh 2 KAMAL</a> </p>
                        </p>
                    </div>
                </div>
            </div>
