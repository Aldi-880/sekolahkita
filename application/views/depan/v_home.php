...
<!-- <div class="slider_area"> -->
        <!-- <div class="slider_active owl-carousel"> -->
            ...
            <!-- <div class="single_slider  d-flex align-items-center slider_bg_1"> -->
                <div style="background-image: url('style/img/banner/b2.jpg') ;">
                    <div class="row">
                        <div class="col-xl-12">
                            <!-- <div class="slider_text "> -->
                                <h1 class="text-center text-black" >SDN BANYUAJUH 2 KAMAL </h1>
                                <h2 class="text-center text-black">Memajukan Dunia Pendidikan Menggunakan Teknologi </h2>
                            <!-- </div> -->
                        </div>
                    </div>
                <!-- </div> -->
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single__program">
                                <div class="program_thumb">
                                    <img src="img/projek_KP/sd.jpg" alt="">
                                </div>
